...
rule merge_bed:
    ...
    shell:
        ...
        plink --bfile ${{in_filename}} --merge-list {input.list} --make-bed --biallelic-only --set-missing-var-ids @:#\$1,\$2 --out ${{out_filename}} --allow-extra-chr --flip-scan --flip results/{wildcards.SOURCE}/all-merge.missnp.
        """
